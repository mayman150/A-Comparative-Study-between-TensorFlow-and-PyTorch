...
def getSignificantKeywords(method_names, threshold=2):
    
    # Step 1: Remove common prefixes and suffixes
    common_prefixes_suffixes = ['get', 'set', 'is', 'add', 'remove', 'create', 'update', 'delete']
...
def compute_average_AMGI(method_names):
    ...
    for keyword in api_keywords:
        run_lengths = compute_run_lengths(keyword, method_names)
