...
* <b>`batchnorm_layer`</b>: <a href="../../../../tf/layers/BatchNormalization.md"><code>tf.compat.v1.layers.BatchNormalization</code></a> layer object. If
  `None`, defaults to
...
* <b>`ValueError`</b>: If bn_layer is not an instance of
  <a href="../../../../tf/layers/BatchNormalization.md"><code>tf.compat.v1.layers.BatchNormalization</code></a>, or if it is specified with
  `renorm=True`
