...
[`class MirroredStrategy`](../../../tf/compat/v2/distribute/MirroredStrategy.md): Mirrors vars to distribute across multiple devices and machines.

[`class NcclAllReduce`](../../../tf/distribute/NcclAllReduce.md): Reduction using NCCL all-reduce.

[`class OneDeviceStrategy`](../../../tf/compat/v2/distribute/OneDeviceStrategy.md): A distribution strategy for running on a single device.
...
[`class Strategy`](../../../tf/compat/v2/distribute/Strategy.md): A state & compute distribution policy on a list of devices.

[`class StrategyExtended`](../../../tf/compat/v2/distribute/StrategyExtended.md): Additional APIs for algorithms that need to be distribution-aware.
