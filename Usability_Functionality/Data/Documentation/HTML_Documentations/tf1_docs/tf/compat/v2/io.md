...
[`decode_csv(...)`](../../../tf/compat/v2/io/decode_csv.md): Convert CSV records to tensors. Each column maps to one tensor.
...
[`decode_raw(...)`](../../../tf/compat/v2/io/decode_raw.md): Convert raw byte strings into tensors.
...
[`parse_example(...)`](../../../tf/compat/v2/io/parse_example.md): Parses `Example` protos into a `dict` of tensors.

[`parse_sequence_example(...)`](../../../tf/io/parse_sequence_example.md): Parses a batch of `SequenceExample` protos.

[`parse_single_example(...)`](../../../tf/compat/v2/io/parse_single_example.md): Parses a single `Example` proto.
...
[`serialize_many_sparse(...)`](../../../tf/compat/v2/io/serialize_many_sparse.md): Serialize `N`-minibatch `SparseTensor` into an `[N, 3]` `Tensor`.

[`serialize_sparse(...)`](../../../tf/compat/v2/io/serialize_sparse.md): Serialize a `SparseTensor` into a 3-vector (1-D `Tensor`) object.
