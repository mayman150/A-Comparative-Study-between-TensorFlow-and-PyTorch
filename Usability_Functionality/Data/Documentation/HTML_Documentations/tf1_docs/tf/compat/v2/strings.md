...
[`split(...)`](../../../tf/compat/v2/strings/split.md): Split elements of `input` based on `sep` into a `RaggedTensor`.

[`strip(...)`](../../../tf/strings/strip.md): Strip leading and trailing whitespaces from the Tensor.

[`substr(...)`](../../../tf/compat/v2/strings/substr.md): Return substrings from `Tensor` of strings.

[`to_hash_bucket(...)`](../../../tf/compat/v2/strings/to_hash_bucket.md): Converts each string in the input Tensor to its hash mod by a number of buckets.
...
[`to_number(...)`](../../../tf/compat/v2/strings/to_number.md): Converts each string in the input Tensor to the specified numeric type.
