...
[`argmin(...)`](../../../tf/compat/v2/argmin.md): Returns the index with the smallest value across axes of a tensor.
...
[`bincount(...)`](../../../tf/compat/v2/math/bincount.md): Counts the number of occurrences of each value in an integer array.

[`ceil(...)`](../../../tf/math/ceil.md): Returns element-wise smallest integer not less than x.

[`confusion_matrix(...)`](../../../tf/compat/v2/math/confusion_matrix.md): Computes the confusion matrix from predictions and labels.
...
[`count_nonzero(...)`](../../../tf/compat/v2/math/count_nonzero.md): Computes number of nonzero elements across dimensions of a tensor.
...
[`scalar_mul(...)`](../../../tf/compat/v2/scalar_mul.md): Multiplies a scalar times a `Tensor` or `IndexedSlices` object.
