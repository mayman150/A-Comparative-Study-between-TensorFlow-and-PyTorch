...
* Class `tf.compat.v2.compat.v1.estimator.SummarySaverHook`
* Class `tf.compat.v2.compat.v1.train.SummarySaverHook`
...
* <b>`summary_op`</b>: `Tensor` of type `string` containing the serialized `Summary`
  ...
  TF summary methods like <a href="../../tf/summary/scalar.md"><code>tf.compat.v1.summary.scalar</code></a> or
  <a href="../../tf/summary/merge_all.md"><code>tf.compat.v1.summary.merge_all</code></a>. It can be passed in as one tensor; if
