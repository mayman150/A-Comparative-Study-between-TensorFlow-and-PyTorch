...
* Class `tf.compat.v2.compat.v1.train.Checkpoint`
...
that contain trackable state, such as <a href="../../tf/train/Optimizer.md"><code>tf.compat.v1.train.Optimizer</code></a>
...
checkpoints, in contrast to <a href="../../tf/train/Saver.md"><code>tf.compat.v1.train.Saver</code></a> which writes and reads
...
eagerly. Prefer <a href="../../tf/train/Checkpoint.md"><code>tf.train.Checkpoint</code></a> over <a href="../../tf/train/Saver.md"><code>tf.compat.v1.train.Saver</code></a> for new
code.
...
Name-based <a href="../../tf/train/Saver.md"><code>tf.compat.v1.train.Saver</code></a> checkpoints can be loaded using this
