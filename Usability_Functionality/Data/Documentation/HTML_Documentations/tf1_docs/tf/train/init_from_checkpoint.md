...
* `tf.compat.v2.compat.v1.train.init_from_checkpoint`
* `tf.train.init_from_checkpoint`
...
(typically by running a <a href="../../tf/initializers/global_variables.md"><code>tf.compat.v1.global_variables_initializer</code></a> op).
