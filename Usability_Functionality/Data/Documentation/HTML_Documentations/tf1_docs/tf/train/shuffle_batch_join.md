...
* `tf.compat.v2.compat.v1.train.shuffle_batch_join`
* `tf.train.shuffle_batch_join`
...
to the `tensors` argument of <a href="../../tf/train/shuffle_batch.md"><code>tf.compat.v1.train.shuffle_batch()</code></a>.
