...
* Class `tf.compat.v2.compat.v1.train.experimental.MixedPrecisionLossScaleOptimizer`
...
* <b>`var_list`</b>: Optional list or tuple of <a href="../../../tf/Variable.md"><code>tf.Variable</code></a> to update to minimize
  ...
  the key <a href="../../../tf/GraphKeys.md#TRAINABLE_VARIABLES"><code>GraphKeys.TRAINABLE_VARIABLES</code></a>.
