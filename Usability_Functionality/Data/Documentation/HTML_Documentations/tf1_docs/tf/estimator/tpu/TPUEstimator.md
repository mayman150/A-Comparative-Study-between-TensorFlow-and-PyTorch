...
* Class `tf.compat.v2.compat.v1.estimator.tpu.TPUEstimator`
...
<a href="../../../tf/estimator/tpu/TPUEstimatorSpec.md#eval_metrics"><code>TPUEstimatorSpec.eval_metrics</code></a> is a tuple of `metric_fn` and `tensors`, where
...
`export_saved_model` exports 2 metagraphs, one with <a href="../../../tf/saved_model.md#SERVING"><code>saved_model.SERVING</code></a>, and
another with <a href="../../../tf/saved_model.md#SERVING"><code>saved_model.SERVING</code></a> and <a href="../../../tf/saved_model.md#TPU"><code>saved_model.TPU</code></a> tags. At serving
...
wraps <a href="../../../tf/tpu/rewrite.md"><code>tpu.rewrite()</code></a> and `TPUPartitionedCallOp` around `model_fn` so
`model_fn` is on TPU by default. To place ops on CPU,
<a href="../../../tf/tpu/outside_compilation.md"><code>tpu.outside_compilation(host_call, logits)</code></a> can be used.
...
`True`, users need to call <a href="../../../tf/tpu/rewrite.md"><code>tpu.rewrite()</code></a>, `TPUPartitionedCallOp` and/or
