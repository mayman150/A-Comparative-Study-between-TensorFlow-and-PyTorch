...
* `tf.compat.v2.compat.v1.estimator.train_and_evaluate`
...
<a href="../../tf/estimator/Estimator.md#train"><code>Estimator.train</code></a>. For a three-training-worker distributed configuration, each
