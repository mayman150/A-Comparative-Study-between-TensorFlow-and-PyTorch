...
* Class `tf.compat.v2.compat.v1.estimator.BinaryClassHead`
* Class `tf.compat.v2.estimator.BinaryClassHead`
* Class `tf.estimator.BinaryClassHead`



Defined in [`python/estimator/head/binary_class_head.py`](https://github.com/tensorflow/estimator/tree/master/tensorflow_estimator/python/estimator/head/binary_class_head.py).
