...
* Class `tf.compat.v2.compat.v1.estimator.MultiClassHead`
* Class `tf.compat.v2.estimator.MultiClassHead`
* Class `tf.estimator.MultiClassHead`



Defined in [`python/estimator/head/multi_class_head.py`](https://github.com/tensorflow/estimator/tree/master/tensorflow_estimator/python/estimator/head/multi_class_head.py).
