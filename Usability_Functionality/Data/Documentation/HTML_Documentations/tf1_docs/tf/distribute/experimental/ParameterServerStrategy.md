...
* Class `tf.compat.v1.distribute.experimental.ParameterServerStrategy`
* Class `tf.compat.v2.compat.v1.distribute.experimental.ParameterServerStrategy`
...
<a href="../../../tf/colocate_with.md"><code>tf.compat.v1.colocate_with</code></a>) under the strategy's scope. For colocating
