description: Monitors the loss tensor and stops training if loss is NaN. (deprecated)
...
Monitors the loss tensor and stops training if loss is NaN. (deprecated)
...
<tr>
<td>
`loss_tensor`<a id="loss_tensor"></a>
</td>
<td>
...
<td>
`fail_on_nan_loss`<a id="fail_on_nan_loss"></a>
</td>
<td>
