description: Provides information about the session.run() call being made. (deprecated)
...
<tr>
<td>
`original_args`<a id="original_args"></a>
</td>
<td>
...
<td>
`stop_requested`<a id="stop_requested"></a>
</td>
<td>
