description: A hook which evaluates Tensors at the end of a session. (deprecated)
...
A hook which evaluates `Tensors` at the end of a session. (deprecated)
...
<td>
`final_ops_feed_dict`<a id="final_ops_feed_dict"></a>
</td>
<td>
...
<tr>
<td>
`final_ops_values`<a id="final_ops_values"></a>
</td>
<td>
