description: An estimator for TensorFlow DNN models with user-specified head. (deprecated)
...
An estimator for TensorFlow DNN models with user-specified head. (deprecated)
