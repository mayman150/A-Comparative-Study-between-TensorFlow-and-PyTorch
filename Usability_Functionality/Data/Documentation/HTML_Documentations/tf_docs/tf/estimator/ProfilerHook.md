description: Captures CPU/GPU profiling information every N steps or seconds. (deprecated)
...
Captures CPU/GPU profiling information every N steps or seconds. (deprecated)
...
<td>
`show_dataflow`<a id="show_dataflow"></a>
</td>
<td>
...
<td>
`show_memory`<a id="show_memory"></a>
</td>
<td>
