description: An estimator for TensorFlow linear models with user-specified head. (deprecated)
...
An estimator for TensorFlow linear models with user-specified head. (deprecated)
