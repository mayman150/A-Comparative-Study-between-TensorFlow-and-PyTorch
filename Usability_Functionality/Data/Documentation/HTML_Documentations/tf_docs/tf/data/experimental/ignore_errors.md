description: Creates a Dataset from another Dataset and silently ignores any errors. (deprecated)
...
Use <a href="../../../tf/data/Dataset.md#ignore_errors"><code>tf.data.Dataset.ignore_errors</code></a> instead.
