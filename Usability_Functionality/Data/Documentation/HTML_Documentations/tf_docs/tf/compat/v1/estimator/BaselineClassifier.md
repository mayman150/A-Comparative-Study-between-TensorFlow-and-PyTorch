description: A classifier that can establish a simple baseline. (deprecated) (deprecated)
...
A classifier that can establish a simple baseline. (deprecated) (deprecated)
