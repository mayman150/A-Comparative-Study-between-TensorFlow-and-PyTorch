description: Returns the index with the smallest value across dimensions of a tensor. (deprecated)
...
<code>tf.compat.v1.arg_min(
    ...
    output_type: TV_ArgMin_output_type = <a href="../../../tf/dtypes.md#int64"><code>tf.dtypes.int64</code></a>,
    name=None
