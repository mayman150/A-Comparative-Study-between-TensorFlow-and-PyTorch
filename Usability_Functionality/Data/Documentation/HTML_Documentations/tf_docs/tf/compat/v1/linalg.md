description: Public API for tf._api.v2.linalg namespace
...
[`experimental`](../../../tf/compat/v1/linalg/experimental.md) module: Public API for tf._api.v2.linalg.experimental namespace
...
[`diag(...)`](../../../tf/compat/v1/linalg/diag.md): Returns a batched diagonal tensor with given batched diagonal values.

[`diag_part(...)`](../../../tf/compat/v1/linalg/diag_part.md): Returns the batched diagonal part of a batched tensor.
...
[`matmul(...)`](../../../tf/compat/v1/linalg/matmul.md): Multiplies matrix `a` by matrix `b`, producing `a` * `b`.

[`matrix_rank(...)`](../../../tf/linalg/matrix_rank.md): Compute the matrix rank of one or more matrices.

[`matrix_transpose(...)`](../../../tf/compat/v1/linalg/matrix_transpose.md): Transposes last two dimensions of tensor `a`.
...
[`tensor_diag_part(...)`](../../../tf/compat/v1/linalg/tensor_diag_part.md): Returns the diagonal part of the tensor.

[`tensordot(...)`](../../../tf/tensordot.md): Tensor contraction of a and b along specified axes and outer product.

[`trace(...)`](../../../tf/compat/v1/linalg/trace.md): Compute the trace of a tensor `x`.

[`transpose(...)`](../../../tf/compat/v1/linalg/matrix_transpose.md): Transposes last two dimensions of tensor `a`.
