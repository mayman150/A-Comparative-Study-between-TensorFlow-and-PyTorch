description: A regressor that can establish a simple baseline. (deprecated) (deprecated)
...
A regressor that can establish a simple baseline. (deprecated) (deprecated)
