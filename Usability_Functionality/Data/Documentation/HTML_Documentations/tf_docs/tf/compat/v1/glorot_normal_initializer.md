...
<meta itemprop="name" content="tf.compat.v1.glorot_normal_initializer" />
...
more details.</p>
<p>`tf.compat.v1.initializers.glorot_normal`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>tf.compat.v1.glorot_normal_initializer(
    seed=None,
