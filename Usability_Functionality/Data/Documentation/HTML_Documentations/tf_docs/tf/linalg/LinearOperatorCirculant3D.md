...
<code>tf.linalg.LinearOperatorCirculant3D(
    spectrum: <a href="../../tf/Tensor.md"><code>tf.Tensor</code></a>,
...
<td>
 Shape `[B1,...,Bb, N0, N1, N2]` `Tensor`.  Allowed dtypes:
`float16`, `float32`, `float64`, `complex64`, `complex128`.
Type can be different than `input_output_dtype`
</td>
</tr><tr>
<td>
`input_output_dtype`<a id="input_output_dtype"></a>
</td>
<td>
...
<td>
`block_depth`<a id="block_depth"></a>
</td>
<td>
