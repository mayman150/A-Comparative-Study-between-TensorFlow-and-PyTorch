...
shapes. For example, `y` can be:
  ...
  - A <a href="../tf/Tensor.md"><code>tf.Tensor</code></a> object of dtype <a href="../tf.md#bool"><code>tf.bool</code></a> of the same shape or
    [broadcast-compatible](http://docs.scipy.org/doc/numpy/user/basics.broadcasting.html)
    shape. In this case, the result will be the element-wise logical AND of
    `x` and `y`.
  - A <a href="../tf/RaggedTensor.md"><code>tf.RaggedTensor</code></a> object of dtype <a href="../tf.md#bool"><code>tf.bool</code></a> of the same shape or
    [broadcast-compatible](http://docs.scipy.org/doc/numpy/user/basics.broadcasting.html)
    shape. In this case, the result will be the element-wise logical AND of
    `x` and `y`.
...
<td>
A Python boolean or a <a href="../tf/Tensor.md"><code>tf.Tensor</code></a> or <a href="../tf/RaggedTensor.md"><code>tf.RaggedTensor</code></a> of dtype
<a href="../tf.md#bool"><code>tf.bool</code></a>.
</td>
</tr><tr>
<td>
`name`
...
<tr class="alt">
<td colspan="2">
A <a href="../tf/RaggedTensor.md"><code>tf.RaggedTensor</code></a> of dtype <a href="../tf.md#bool"><code>tf.bool</code></a> with the shape that `x` and `y`
broadcast to.
</td>
</tr>
...
<tr class="alt">
<td colspan="2">
A <a href="../tf/RaggedTensor.md"><code>tf.RaggedTensor</code></a> of dtype <a href="../tf.md#bool"><code>tf.bool</code></a> with the shape that `self` and
`other` broadcast to.
</td>
</tr>
