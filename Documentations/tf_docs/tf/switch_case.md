description: Create a switch/case operation, i.e.
...
<a target="_blank" class="external" href="/code/stable/tensorflow/python/ops/control_flow_switch_case.py">View source</a>
