description: Public API for tf._api.v2.debugging namespace
...
[`experimental`](../../../tf/compat/v1/debugging/experimental.md) module: Public API for tf._api.v2.debugging.experimental namespace
...
[`check_numerics(...)`](../../../tf/compat/v1/debugging/check_numerics.md): Checks a tensor for NaN and Inf values.
