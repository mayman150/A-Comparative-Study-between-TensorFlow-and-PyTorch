description: Public API for tf._api.v2.raw_ops namespace
...
[`QuantizedMatMulWithBias(...)`](../../../tf/raw_ops/QuantizedMatMulWithBias.md): Performs a quantized matrix multiplication of `a` by the matrix `b` with bias add.

[`QuantizedMatMulWithBiasAndDequantize(...)`](../../../tf/raw_ops/QuantizedMatMulWithBiasAndDequantize.md)

[`QuantizedMatMulWithBiasAndRelu(...)`](../../../tf/raw_ops/QuantizedMatMulWithBiasAndRelu.md): Perform a quantized matrix multiplication of `a` by the matrix `b` with bias add and relu fusion.

[`QuantizedMatMulWithBiasAndReluAndRequantize(...)`](../../../tf/raw_ops/QuantizedMatMulWithBiasAndReluAndRequantize.md): Perform a quantized matrix multiplication of `a` by the matrix `b` with bias add and relu and requantize fusion.
...
[`RFFTND(...)`](../../../tf/raw_ops/RFFTND.md): ND fast real Fourier transform.
...
[`RaggedCross(...)`](../../../tf/raw_ops/RaggedCross.md): Generates a feature cross from a list of tensors, and returns it as a RaggedTensor.

[`RaggedFillEmptyRows(...)`](../../../tf/raw_ops/RaggedFillEmptyRows.md)

[`RaggedFillEmptyRowsGrad(...)`](../../../tf/raw_ops/RaggedFillEmptyRowsGrad.md)
...
[`RandomDatasetV2(...)`](../../../tf/raw_ops/RandomDatasetV2.md): Creates a Dataset that returns pseudorandom numbers.
...
[`RegexReplace(...)`](../../../tf/raw_ops/RegexReplace.md): Replaces matches of the `pattern` regular expression in `input` with the replacement string provided in `rewrite`.

[`RegisterDataset(...)`](../../../tf/raw_ops/RegisterDataset.md): Registers a dataset with the tf.data service.

[`RegisterDatasetV2(...)`](../../../tf/raw_ops/RegisterDatasetV2.md): Registers a dataset with the tf.data service.
...
[`RewriteDataset(...)`](../../../tf/raw_ops/RewriteDataset.md)
...
[`SegmentMaxV2(...)`](../../../tf/raw_ops/SegmentMaxV2.md): Computes the maximum along segments of a tensor.
...
[`SegmentMinV2(...)`](../../../tf/raw_ops/SegmentMinV2.md): Computes the minimum along segments of a tensor.

[`SegmentProd(...)`](../../../tf/raw_ops/SegmentProd.md): Computes the product along segments of a tensor.

[`SegmentProdV2(...)`](../../../tf/raw_ops/SegmentProdV2.md): Computes the product along segments of a tensor.

[`SegmentSum(...)`](../../../tf/raw_ops/SegmentSum.md): Computes the sum along segments of a tensor.

[`SegmentSumV2(...)`](../../../tf/raw_ops/SegmentSumV2.md): Computes the sum along segments of a tensor.
...
[`ShardedFilename(...)`](../../../tf/raw_ops/ShardedFilename.md): Generate a sharded filename.
...
[`SnapshotChunkDataset(...)`](../../../tf/raw_ops/SnapshotChunkDataset.md)
...
[`SparseSegmentMeanGradV2(...)`](../../../tf/raw_ops/SparseSegmentMeanGradV2.md): Computes gradients for SparseSegmentMean.
...
[`SparseSegmentSqrtNGradV2(...)`](../../../tf/raw_ops/SparseSegmentSqrtNGradV2.md): Computes gradients for SparseSegmentSqrtN.
...
[`SparseSegmentSumGradV2(...)`](../../../tf/raw_ops/SparseSegmentSumGradV2.md): Computes gradients for SparseSegmentSum.
...
[`StagePeek(...)`](../../../tf/raw_ops/StagePeek.md): Op peeks at the values at the specified index.
...
[`StatefulStandardNormal(...)`](../../../tf/raw_ops/StatefulStandardNormal.md): Outputs random values from a normal distribution.
...
[`StatelessRandomGammaV3(...)`](../../../tf/raw_ops/StatelessRandomGammaV3.md): Outputs deterministic pseudorandom random numbers from a gamma distribution.
...
[`StatelessShuffle(...)`](../../../tf/raw_ops/StatelessShuffle.md): Randomly and deterministically shuffles a tensor along its first dimension.
...
[`SyncDevice(...)`](../../../tf/raw_ops/SyncDevice.md): Synchronizes the device this op is run on.

[`TFRecordDataset(...)`](../../../tf/raw_ops/TFRecordDataset.md): Creates a dataset that emits the records from one or more TFRecord files.

[`TFRecordDatasetV2(...)`](../../../tf/raw_ops/TFRecordDatasetV2.md): Creates a dataset that emits the records from one or more TFRecord files.
...
[`TPUPartitionedInput(...)`](../../../tf/raw_ops/TPUPartitionedInput.md): An op that groups a list of partitioned inputs together.

[`TPUPartitionedInputV2(...)`](../../../tf/raw_ops/TPUPartitionedInputV2.md): An op that groups a list of partitioned inputs together. Supports ND sharding.
...
[`TPUPartitionedOutputV2(...)`](../../../tf/raw_ops/TPUPartitionedOutputV2.md): An op that demultiplexes a tensor to be sharded by XLA to a list of partitioned
...
[`TensorArrayCloseV2(...)`](../../../tf/raw_ops/TensorArrayCloseV2.md): Deprecated.
...
[`TensorArrayConcatV2(...)`](../../../tf/raw_ops/TensorArrayConcatV2.md): Deprecated.
...
[`TensorArrayGatherV2(...)`](../../../tf/raw_ops/TensorArrayGatherV2.md): Deprecated.
...
[`TensorArrayGradV2(...)`](../../../tf/raw_ops/TensorArrayGradV2.md): Deprecated.
...
[`TensorArrayReadV2(...)`](../../../tf/raw_ops/TensorArrayReadV2.md): Deprecated.
...
[`TensorArrayScatterV2(...)`](../../../tf/raw_ops/TensorArrayScatterV2.md): Deprecated.
...
[`TensorArraySizeV2(...)`](../../../tf/raw_ops/TensorArraySizeV2.md): Deprecated.
...
[`TensorArraySplitV2(...)`](../../../tf/raw_ops/TensorArraySplitV2.md): Deprecated.
...
[`TensorArrayV2(...)`](../../../tf/raw_ops/TensorArrayV2.md): Deprecated.
...
[`TensorArrayWriteV2(...)`](../../../tf/raw_ops/TensorArrayWriteV2.md): Deprecated.
...
[`TensorMapErase(...)`](../../../tf/raw_ops/TensorMapErase.md): Returns a tensor map with item from given key erased.

[`TensorMapHasKey(...)`](../../../tf/raw_ops/TensorMapHasKey.md): Returns whether the given key exists in the map.

[`TensorMapInsert(...)`](../../../tf/raw_ops/TensorMapInsert.md): Returns a map that is the 'input_handle' with the given key-value pair inserted.

[`TensorMapLookup(...)`](../../../tf/raw_ops/TensorMapLookup.md): Returns the value from a given key in a tensor map.

[`TensorMapSize(...)`](../../../tf/raw_ops/TensorMapSize.md): Returns the number of tensors in the input tensor map.

[`TensorMapStackKeys(...)`](../../../tf/raw_ops/TensorMapStackKeys.md): Returns a Tensor stack of all keys in a tensor map.
...
[`TruncateDiv(...)`](../../../tf/raw_ops/TruncateDiv.md): Returns x / y element-wise, rounded towards zero.

[`TruncateMod(...)`](../../../tf/raw_ops/TruncateMod.md): Returns element-wise remainder of division.
...
[`UniformDequantize(...)`](../../../tf/raw_ops/UniformDequantize.md): Perform dequantization on the quantized Tensor `input`.

[`UniformQuantize(...)`](../../../tf/raw_ops/UniformQuantize.md): Perform quantization on Tensor `input`.

[`UniformQuantizedAdd(...)`](../../../tf/raw_ops/UniformQuantizedAdd.md): Perform quantized add of quantized Tensor `lhs` and quantized Tensor `rhs` to make quantized `output`.

[`UniformQuantizedClipByValue(...)`](../../../tf/raw_ops/UniformQuantizedClipByValue.md): Perform clip by value on the quantized Tensor `operand`.

[`UniformQuantizedConvolution(...)`](../../../tf/raw_ops/UniformQuantizedConvolution.md): Perform quantized convolution of quantized Tensor `lhs` and quantized Tensor `rhs`. to make quantized `output`.

[`UniformQuantizedConvolutionHybrid(...)`](../../../tf/raw_ops/UniformQuantizedConvolutionHybrid.md): Perform hybrid quantized convolution of float Tensor `lhs` and quantized Tensor `rhs`.

[`UniformQuantizedDot(...)`](../../../tf/raw_ops/UniformQuantizedDot.md): Perform quantized dot of quantized Tensor `lhs` and quantized Tensor `rhs` to make quantized `output`.

[`UniformQuantizedDotHybrid(...)`](../../../tf/raw_ops/UniformQuantizedDotHybrid.md): Perform hybrid quantized dot of float Tensor `lhs` and quantized Tensor `rhs`.

[`UniformRequantize(...)`](../../../tf/raw_ops/UniformRequantize.md): Given quantized tensor `input`, requantize it with new quantization parameters.
...
[`UnsortedSegmentJoin(...)`](../../../tf/raw_ops/UnsortedSegmentJoin.md)
