description: An estimator that can establish a simple baseline. (deprecated) (deprecated)
...
An estimator that can establish a simple baseline. (deprecated) (deprecated)
