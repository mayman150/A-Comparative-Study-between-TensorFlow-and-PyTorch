...
<meta itemprop="name" content="tf.compat.v1.glorot_uniform_initializer" />
...
Inherits From: [`variance_scaling_initializer`](../../../tf/compat/v1/variance_scaling_initializer.md)
...
more details.</p>
<p>`tf.compat.v1.initializers.glorot_uniform`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>tf.compat.v1.glorot_uniform_initializer(
    seed=None,
