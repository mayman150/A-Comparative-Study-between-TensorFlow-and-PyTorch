description: Public API for tf._api.v2.random namespace
...
[`experimental`](../../../tf/compat/v1/random/experimental.md) module: Public API for tf._api.v2.random.experimental namespace
