...
[`class GlobalMaxPool1D`](../../tf/keras/layers/GlobalMaxPooling1D.md): Global max pooling operation for 1D temporal data.
...
[`class MaxPool2D`](../../tf/keras/layers/MaxPooling2D.md): Max pooling operation for 2D spatial data.
