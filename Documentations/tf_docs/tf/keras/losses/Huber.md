description: Computes the Huber loss between y_true & y_pred.
...
<td>
  <a target="_blank" href="https://github.com/keras-team/keras/tree/v2.15.0/keras/losses.py#L1601-L1668">
...
<td>
A float, the point where the Huber loss function changes from
