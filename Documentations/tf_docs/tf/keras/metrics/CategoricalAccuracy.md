...
<td>
  <a target="_blank" href="https://github.com/keras-team/keras/tree/v2.15.0/keras/metrics/accuracy_metrics.py#L118-L174">
...
rather than as labels. If necessary, use <a href="../../../tf/one_hot.md"><code>tf.one_hot</code></a> to expand `y_true` as
a vector.
