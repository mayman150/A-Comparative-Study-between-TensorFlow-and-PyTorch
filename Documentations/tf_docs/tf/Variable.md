...
<tr>
<td>
`initial_value`<a id="initial_value"></a>
</td>
<td>
...
<td>
`variable_def`<a id="variable_def"></a>
</td>
<td>
...
<td>
`experimental_enable_variable_lifting`<a id="experimental_enable_variable_lifting"></a>
</td>
<td>
Whether to lift the variable out if
it's in a <a href="../tf/function.md"><code>tf.function</code></a>. Default is `True`. When this argument
...
<a href="../tf/function.md"><code>tf.function</code></a>, as if it's a "mutable <a href="../tf/Tensor.md"><code>tf.Tensor</code></a>". You can't
