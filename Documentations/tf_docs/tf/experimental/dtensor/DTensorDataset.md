description: A dataset of DTensors.

<div itemscope itemtype="http://developers.google.com/ReferenceObject">
<meta itemprop="name" content="tf.experimental.dtensor.DTensorDataset" />
...
<a target="_blank" class="external" href="/code/stable/tensorflow/dtensor/python/input_util.py">View source</a>
...
<code>tf.experimental.dtensor.DTensorDataset(
...
DTensorDataset encapsulates a <a href="../../../tf/data/Dataset.md"><code>tf.data.Dataset</code></a> whose elements are
...
<td>
the DTensor mesh to place the dataset batches on.
</td>
</tr><tr>
<td>
...
<td>
a structure of DTensor layouts to be applied to the input dataset
...
<td>
the desired global batch size.
</td>
</tr><tr>
<td>
`dataset_already_batched`<a id="dataset_already_batched"></a>
</td>
<td>
must be set only if the dataset is already
...
<td>
`batch_dim`<a id="batch_dim"></a>
</td>
<td>
the mesh dimension on which the input's batch dimension is
sharded. Set to None if the input layouts do not shard on the batch
dimension.
</td>
</tr><tr>
<td>
`prefetch`<a id="prefetch"></a>
</td>
<td>
number of batches to prefetch using Dataset.prefetch.
</td>
</tr><tr>
<td>
...
<td>
if operating in multi-client mode, this config
...
<td>
if type of structures of layouts and the dataset do not match.
</td>
</tr>
</table>
