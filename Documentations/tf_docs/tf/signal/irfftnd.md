...
<meta itemprop="name" content="tf.signal.irfftnd" />
...
more details.</p>
<p>`tf.compat.v1.signal.irfftnd`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>tf.signal.irfftnd(
...
designated dimensions of `input_tensor`. The designated dimensions of `input_tensor` are
