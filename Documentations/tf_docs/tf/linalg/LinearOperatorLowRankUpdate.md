...
<tr>
<td>
`base_operator`<a id="base_operator"></a>
</td>
<td>
 Shape `[B1,...,Bb, M, N]`.
</td>
...
<td>
`diag_update`<a id="diag_update"></a>
</td>
<td>
...
<td>
`is_diag_update_positive`<a id="is_diag_update_positive"></a>
</td>
<td>
 Python `bool`.
...
<td>
`diag_operator`<a id="diag_operator"></a>
</td>
<td>
