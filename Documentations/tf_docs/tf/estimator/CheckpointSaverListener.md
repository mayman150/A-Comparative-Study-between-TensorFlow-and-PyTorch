description: Interface for listeners that take action before or after checkpoint save. (deprecated)
...
Interface for listeners that take action before or after checkpoint save. (deprecated)
...
<code>tf.estimator.CheckpointSaverListener(
    *args, **kwargs
)
</code></pre>
