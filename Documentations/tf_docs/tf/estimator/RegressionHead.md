description: Creates a Head for regression using the mean_squared_error loss. (deprecated)
...
Creates a `Head` for regression using the `mean_squared_error` loss. (deprecated)
...
<td>
`inverse_link_fn`<a id="inverse_link_fn"></a>
</td>
<td>
