description: Prints the given tensors every N local steps, every N seconds, or at end. (deprecated)
...
Prints the given tensors every N local steps, every N seconds, or at end. (deprecated)
...
<td>
`every_n_iter`<a id="every_n_iter"></a>
</td>
<td>
...
<td>
`every_n_secs`<a id="every_n_secs"></a>
</td>
<td>
