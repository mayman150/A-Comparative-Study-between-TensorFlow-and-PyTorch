description: An estimator for TensorFlow Linear and DNN joined models with custom head. (deprecated)
...
An estimator for TensorFlow Linear and DNN joined models with custom head. (deprecated)
...
<td>
`linear_feature_columns`<a id="linear_feature_columns"></a>
</td>
<td>
...
<td>
`linear_optimizer`<a id="linear_optimizer"></a>
</td>
<td>
...
<td>
`dnn_feature_columns`<a id="dnn_feature_columns"></a>
</td>
<td>
...
<td>
`dnn_optimizer`<a id="dnn_optimizer"></a>
</td>
<td>
An instance of `tf.keras.optimizers.*` used to apply
...
<td>
`dnn_hidden_units`<a id="dnn_hidden_units"></a>
</td>
<td>
...
<td>
`dnn_activation_fn`<a id="dnn_activation_fn"></a>
</td>
<td>
...
<td>
`dnn_dropout`<a id="dnn_dropout"></a>
</td>
<td>
...
<td>
`linear_sparse_combiner`<a id="linear_sparse_combiner"></a>
</td>
<td>
