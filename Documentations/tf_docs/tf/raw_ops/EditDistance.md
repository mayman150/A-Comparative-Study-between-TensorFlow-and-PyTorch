...
<tr>
<td>
`hypothesis_indices`<a id="hypothesis_indices"></a>
</td>
<td>
...
<td>
`hypothesis_values`<a id="hypothesis_values"></a>
</td>
<td>
A `Tensor`.
...
<td>
`hypothesis_shape`<a id="hypothesis_shape"></a>
</td>
<td>
A `Tensor` of type `int64`.
...
<td>
`truth_indices`<a id="truth_indices"></a>
</td>
<td>
A `Tensor` of type `int64`.
...
<td>
`truth_values`<a id="truth_values"></a>
</td>
<td>
...
<td>
`truth_shape`<a id="truth_shape"></a>
</td>
<td>
